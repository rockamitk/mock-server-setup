 ...
 * @create date 2018-12-15 18:48:36
 * @modify date 2018-12-15 18:48:36
 * @desc [description]
*/
...
router.route('/signup').post([
    ...
    check('phoneNo', 'Phone number has required').exists().isMobilePhone().withMessage("Invalid mobile number"),
